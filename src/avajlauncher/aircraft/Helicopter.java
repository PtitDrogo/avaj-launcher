    ...
    public void updateConditions() {
        ...
        switch (weather) {
                case Consts.SUN:
                    ...
                    System.out.println(Consts.HELICOPTER+ "#" + name + "(" + id + "): " + "I love the smell of napalm in the morning");
                case Consts.RAIN:
                    coordinates = new Coordinates(coordinates.getLongitude() + 5, coordinates.getLatitude(), coordinates.getHeight());
                    System.out.println(Consts.HELICOPTER+ "#" + name + "(" + id + "): " + "This rain better not get in the electronics");
                case Consts.FOG:
                    coordinates = new Coordinates(coordinates.getLongitude() + 1, coordinates.getLatitude(), coordinates.getHeight());
                    System.out.println(Consts.HELICOPTER+ "#" + name + "(" + id + "): " + "Good thing I am a mistborn");
                case Consts.SNOW:
                    coordinates = new Coordinates(coordinates.getLongitude(), coordinates.getLatitude(), coordinates.getHeight() - 12);
                    System.out.println(Consts.HELICOPTER+ "#" + name + "(" + id + "): " + "I don't rotate as fast because of this snow");
                default:
